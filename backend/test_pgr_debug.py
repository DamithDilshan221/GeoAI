...
points_sql = f"""
    SELECT -1::bigint AS pid, {origin_edge_id}::bigint AS edge_id, {origin_fraction}::float8 AS fraction
    UNION ALL
    SELECT -2::bigint AS pid, {dest_edge_id}::bigint AS edge_id, {dest_fraction}::float8 AS fraction
"""
